...
![test](https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80)

and images in figures:

{% figure layout="half-left" caption="Point of sale" %}
![test](https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80)
{% /figure %}
...
### Let's talk Markdoc components.

This blog uses a few different components to add a little bit of pizazz.

There are notes, which can either have a title or not.

{% note %}
This is the content of a note. Notes can have Markdown in them, such as [this link](https://zombo.com).
{% /note %}
